...
export const PROJECT_GITIGNORE_LINES = [".agenticview/", ".claude/agents/agenticview-*.md", ".agents/plugins/agenticview-*"];
 ...
 */
export async function ensureRootGitignore(projectPath) {
